package com.zxxk.ext.circleimagedemo.view;
...
public class CircleImageView extends ImageView {
    ...
    /**
     * 这个函数很关键，进行图片画笔、边界画笔(Paint)一些重绘参数初始化：
    ...
    private void setup() {
        ...
        if (!mBorderOverlay) {
            //通过inset方法  使得图片显示的区域从mBorderRect大小上下左右 内移边界的宽度形成区域，查看xml边界宽度为2dp（3px）,所以方形边长为就是160-4=156dp(234px)
