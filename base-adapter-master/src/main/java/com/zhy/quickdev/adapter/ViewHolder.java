...
public class ViewHolder
{
	...
	public ViewHolder setText(int viewId, String text, boolean state, int width)
	{
		TextView tv = getView(viewId);
		if (state) {
			tv.setWidth(width);
	...
	public void updateLayout(ItemBean bean, int width, int view_id, int layout_id) {
		CheckBox view = (CheckBox) getView(view_id);
		RelativeLayout.LayoutParams viewParams = (RelativeLayout.LayoutParams)view.getLayoutParams();
		RelativeLayout layout = (RelativeLayout) getView(layout_id);
